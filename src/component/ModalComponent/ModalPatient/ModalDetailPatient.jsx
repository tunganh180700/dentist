...
const ModalDetailPatient = ({ modalDetailOpen, setModalDetailOpen }) => {
    ...
    const bodyPrehistory = useSelector(state => state.choosenPatient.bodyPrehistory)
    const teethPrehistory = useSelector(state => state.choosenPatient.teethPrehistory)
                ...
                <Box sx={{ ...style }}>
                    ...
                    {loading === false && <>
                        <div className="box" style={{ marginTop: "40px" }}>
                            <div className="attribute" style={{ display: "flex", justifyContent: "center" }}>
                                <Typography
                                    component="h1"
                                    color="inherit"
                                    noWrap
