...
import { listIncomeAPI, listNetIncomeAPI,listTotalSpendIncomeAPI } from "../../config/baseAPI"
...
export const fetchAllTotalSpendIncome = createAsyncThunk('listIncome/fetchAllTotalSpendIncome', async (paramsSearch) => {
    try {
